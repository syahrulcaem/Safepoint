...
(function ($) {
  ...
  function initActiveMenu() {
    ...
    // Loop through sidebar links and activate based on URL match
    $("#sidebar-menu a").each(function () {
      if (this.href === pageUrl) {
        $(this).addClass("active");
        $(this).parent().addClass("mm-active"); // Active class on li
        $(this).parent().parent().addClass("mm-show"); // Expand parent ul
        $(this).parent().parent().prev().addClass("mm-active"); // Anchor's parent
        $(this).parent().parent().parent().addClass("mm-active"); // Grandparent li
        $(this).parent().parent().parent().parent().addClass("mm-show"); // Expand great-grandparent ul
        $(this)
          .parent()
          .parent()
          .parent()
          .parent()
          .parent()
          .addClass("mm-active"); // Great-grandparent li
      }
    });
  }
  ...
  function initMenuItemScroll() {
    $(document).ready(function () {
      if (
        ...
        var activeMenuOffset = $("#sidebar-menu .mm-active .active").offset()
          .top;

        // Scroll sidebar to active menu if it's further down
        if (activeMenuOffset > 300) {
          activeMenuOffset -= 300; // Adjust to bring it closer to the top
          $(".vertical-menu .simplebar-content-wrapper").animate(
            {
              scrollTop: activeMenuOffset,
            },
            "slow"
          );
        }
  ...
  function layoutSetting() {
    ...
    $("input[name='layout']").on("change", function () {
      ...
      window.location.href = $(this).val() == "vertical" ? "#" : "#";
    });
