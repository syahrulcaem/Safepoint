                    ...
                    <div class="px-6 py-4">
                        <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm font-mono text-gray-900">{{ $case->lat }}, {{ $case->lon }}</dd>
                            </div>
                            ...
                            @if($case->verified_at)
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">{{ $case->verified_at->format('d F Y, H:i') }} WIB</dd>
                                </div>
                            @endif
                            ...
                            @if($case->dispatched_at)
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">{{ $case->dispatched_at->format('d F Y, H:i') }} WIB</dd>
                                </div>
                            @endif
                            ...
                            @if($case->closed_at)
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">{{ $case->closed_at->format('d F Y, H:i') }} WIB</dd>
                                </div>
                            @endif
                        </dl>
                    </div>
                                                ...
                                                <div class="relative flex space-x-3">
                                                    ...
                                                    <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                                        <div>
                                                            ...
                                                            @if($event->notes)
                                                                <p class="mt-1 text-sm text-gray-700">{{ $event->notes }}</p>
                                                            @endif
                                                            @if($event->metadata)
                                                                <div class="mt-2 text-xs text-gray-500">
                                                                    <details>
                                                                        <summary class="cursor-pointer">Detail metadata</summary>
                        ...
                        @if(in_array($case->status, ['DISPATCHED', 'ON_THE_WAY', 'ON_SCENE']))
                            ...
                            <div>
                                <form method="POST" action="{{ route('cases.close', $case) }}" class="space-y-3">
                                    @csrf
                                    <div>
                                        <label for="close_notes" class="block text-sm font-medium text-gray-700">Alasan Penutupan *</label>
                        ...
                        @if(!in_array($case->status, ['CLOSED', 'CANCELLED']))
                            ...
                            <div>
                                <form method="POST" action="{{ route('cases.cancel', $case) }}" class="space-y-3">
                                    @csrf
                                    <div>
                                        <label for="cancel_notes" class="block text-sm font-medium text-gray-700">Alasan Pembatalan *</label>
                    ...
                    <div class="px-6 py-4 space-y-3">
                        ...
                        @if($case->lat && $case->lon)
                            <div class="flex justify-between">
                                ...
                                <span class="text-sm font-mono text-gray-900">{{ round($case->lat, 6) }}, {{ round($case->lon, 6) }}</span>
                            </div>
                        @endif
