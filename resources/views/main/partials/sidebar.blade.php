    ...
    <div data-simplebar class="h-100">
        ...
        <div class="sidebar-header">
            <div class="d-flex align-items-center">
                <img src="{{ asset('assets/img/logosph.png') }}" alt="SafePoint" class="sidebar-logo me-2" style="height: 40px; width: auto;">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="{{ request()->routeIs(['cases.*']) ? 'mm-active' : '' }}">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li class="{{ request()->routeIs('cases.create') ? 'mm-active' : '' }}">
                            <a href="#" key="t-cases-create">Tambah Kasus</a>
                        </li>
                        <li>
                            <a href="#" key="t-cases-reports">Laporan Kasus</a>
                        </li>
                    </ul>
                </li>
                ...
                @if (auth()->check() && auth()->user()->role === 'SUPERADMIN')
                    <li class="{{ request()->routeIs(['units.*', 'users.*']) ? 'mm-active' : '' }}">
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-management">Unit & Pengguna</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
