    ...
    <div class="space-y-6">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600">Kelola user yang dapat mengakses sistem SafePoint</p>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 w-0 flex-1">
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $roleStats['total'] }}</dd>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 w-0 flex-1">
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $roleStats['super_admin'] }}</dd>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 w-0 flex-1">
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $roleStats['admin'] }}</dd>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 w-0 flex-1">
                            <dt class="text-sm font-medium text-gray-500 truncate">Operator</dt>
                            <dd class="text-lg font-medium text-gray-900">{{ $roleStats['operator'] }}</dd>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 w-0 flex-1">
                            <dt class="text-sm font-medium text-gray-500 truncate">Pimpinan</dt>
                            <dd class="text-lg font-medium text-gray-900">{{ $roleStats['pimpinan'] }}</dd>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @switch($user->role)
                                            ...
                                            @case('ADMIN')
                                                <span
                                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-600">
                                                    Admin
                                                </span>
                                            @break
